 ...
 * @author Admin
 */
@WebServlet(name = "searchSubs", urlPatterns = {"/sSubs"})
public class searchSubs extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet searchSubs</title>");
            ...
            out.println("<br><h1>Search Result</h1><br><br>");
            ...
            if (type != null) {
                Collection<Subscription> subscription = pub.getSubscriptionByType(type);
