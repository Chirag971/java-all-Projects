 ...
 * @author Admin
 */
@WebServlet(name = "delCust", urlPatterns = {"/delCust"})
public class delCust extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet delCust</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet delCust at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
